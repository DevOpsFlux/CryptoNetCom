/*-------------------------------------------------------
'	프로그램명	: CryptoNetCom
'	작성자		: Flux (INTERPARK.ENT.TicketDevTeam)
'	작성일		: 2018-01-17
'	설명		: CryptSeed class
' -------------------------------------------------------*/
using System;
...
namespace CryptoNetCom
{
    class CryptSeed
    {
        ...
        private static uint PaddSet(ref byte[] buffer, uint offset, int blkLen, PADDING paddingType)
        {
            ...
            switch (paddingType)
            {
                ...
                case PADDING.AI_PKCS_PADDING:
                    ...
                    if (padLen == 0) padLen = (uint)blkLen;
        ...
        {
            uint encType = 0;
            MODE modeType = MODE.AI_ECB; // AI_ECB AI_CBC;
            PADDING padType = PADDING.AI_NO_PADDING; // AI_NO_PADDING AI_PKCS_PADDING;
            string sRet;
            CODE nErr;
        ...
        public string seedEncryptString(string sKey, string iv, string sValue)
        {
            uint encType = 0;
            MODE modeType = MODE.AI_CBC; // AI_ECB AI_CBC;
            PADDING padType = PADDING.AI_PKCS_PADDING; // AI_NO_PADDING AI_PKCS_PADDING;
            string sRet;
            CODE nErr;
        ...
        public string seedEncryptString(string sKey, string iv, string sMode, string sPadType, string sValue)
        {
            uint encType = 0;
            string sRet;
            CODE nErr;
            ...
            if (sMode== "CBC") modeType = MODE.AI_CBC;
            if (sPadType == "Y") padType = PADDING.AI_PKCS_PADDING;
        ...
        public string seedDecryptString(string sKey, string iv, string sMode, string sPadType, string sValue)
        {
            uint encType = 1;
            string sRet;
            CODE nErr;
